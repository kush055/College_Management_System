                ...
                <div class="boxs-simple">
                    <div class="profile-header">
                        <div class="profile_info">
                            ...
                            <h4 class="mb-0"><strong>Prof. John</strong> Smith</h4>
                    ...
                    <div class="profile-sub-header">
                        <div class="box-list">
                            <ul class="text-center">
                                <li><a href="mail-inbox.php" class=""><i class="zmdi zmdi-email"></i><p>My Inbox</p></a></li>
                                <li><a href="#" class=""><i class="zmdi zmdi-camera"></i><p>Gallery</p></a></li>
                                <li><a href="#"><i class="zmdi zmdi-attachment"></i><p>Collections</p></a></li>
                                <li><a href="#"><i class="zmdi zmdi-format-subject"></i><p>Tasks</p></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <p class="text-default">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                        <blockquote>
                ...
                <div class="card">
                    <div class="body"> 
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#mypost">Activity</a></li>
...
<!-- Mirrored from thememakker.com/templates/swift/university/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 06:15:18 GMT -->
</html>