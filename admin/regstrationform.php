...
<div class="container register">
    ...
    <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="conpassword" class="form-control"  placeholder="Confirm Password *" value="" />
                                        </div>
                                        <div class="form-group">
                                            <div class="maxl">
            ...
            <?php
            if($_name = $_POST['register'])
            {
                $fname = $_post['fname'];
                $fname = $_post['lname'];
                $fname = $_post['password'];
                $fname = $_post['conpassword'];
                $fname = $_post['gender'];
                $fname = $_post['email'];
                $fname = $_post['phone'];
                $fname = $_post['answer'];

                $query =   "INSERT INTO form values('$fname','$lname','$password','$conpassword','$gender','$email','$phone','$answer')";
                $data = mysqli_query($conn,$query);
                if($data)
                {
                    echo " data inserted succefull";
