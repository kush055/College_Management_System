...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2023 at 09:02 AM
...
--
-- Table structure for table `add course`
--

CREATE TABLE `add course` (
  `id` int(12) NOT NULL,
  `name` varchar(15) NOT NULL,
  `starts form` int(10) NOT NULL,
  `course duration` int(18) NOT NULL,
  `course incharge` varchar(28) NOT NULL,
  `department` varchar(28) NOT NULL,
  `year` int(20) NOT NULL,
  `course description` int(30) NOT NULL
...
INSERT INTO `add_students` (`id`, `first_name`, `last_name`, `phone`, `dob`, `age`, `gender`, `department`, `email`) VALUES
(1, 'sumit', 'soni', 9624190909, '2023-03-21', '1', 'Male', 'CE', 'jhonty@coderszine.com'),
(2, 'sanjay', 'shah', 7016530662, '2023-05-12', '0', 'Male', 'CE', 'sanjayvalaki1234@gmail.com'),
(3, 'dddd', 'shukla', 9624190909, '2023-05-15', '0', 'Male', 'CE', 'sarthakpanchal1234@gmail.com'),
(4, 'harsh', 'shah', 9624190909, '2023-05-15', '18', 'Male', 'CDDM', 'harshilsoni90909@gmail.com'),
(5, 'harsh', 'soni', 9624190909, '2023-05-16', '18', 'Female', 'CE', 'sumit1234@gmail.com'),
(6, 'su', 'shukla', 9624190909, '2023-05-26', '18', 'Male', 'CE', 'sumit1234@gmail.com');
...
(1, 'harshilsoni485@gmail.com', '12345');

-- --------------------------------------------------------

--
-- Table structure for table `all_professor`
--

CREATE TABLE `all_professor` (
  `id` int(12) NOT NULL,
  `first_name` varchar(15) NOT NULL,
...
--
-- Dumping data for table `all_professor`
--

INSERT INTO `all_professor` (`id`, `first_name`, `last_name`, `dob`, `gender`, `department`, `position`, `phone`, `email`) VALUES
(52, 'sanjay ', 'soni', '2023-05-16', 'Male', 'CE', 'lecturer', 2147483647, 'sanjayvalaki1234@gma'),
(54, 'su ', 'soni', '2023-05-16', 'Male', 'CE', 'lecturer', 2147483647, 'sumit1234@gmail.com'),
(57, ' ', '', '0000-00-00', '', '', '', 0, ''),
(58, 'harshil  ', 'shukla', '2023-05-16', 'Male', 'IT', 'lecturer', 2147483647, 'harshilsoni90909@gma'),
(59, ' ', '', '0000-00-00', '', '', '', 0, ''),
(60, 'hm ', 'd', '2023-05-19', 'Male', 'CE', 'lecturer', 2147483647, 'jhonty@coderszine.co'),
(61, ' ', '', '0000-00-00', '', '', '', 0, ''),
(62, ' ', '', '0000-00-00', '', '', '', 0, '');
...
--
-- Table structure for table `attandencegraph`
--

CREATE TABLE `attandencegraph` (
  `id` int(12) NOT NULL,
...
--
-- Dumping data for table `attandencegraph`
--

INSERT INTO `attandencegraph` (`id`, `label`, `amount`) VALUES
(1, 'week1', '90'),
(2, 'week2', '60'),
(3, 'week3', '19'),
(4, 'week4', '70');
...
INSERT INTO `contribution` (`students`, `contribution`) VALUES
('harshil', 10),
('kush', 20),
('neev', 30),
('nauman', 40);
...
INSERT INTO `mentor` (`id`, `email`, `pass`) VALUES
(1, 'harshilsoni485@gmail.com', '12345');
...
(1, 'cisa soda powe '),
(2, 'clg is scame for extra fes'),
(3, ' i am harsh shah student '),
(4, 'i am harshil soni'),
(5, ''),
(6, 'hii i am harshil soni'),
(7, ' i am harsh shah student ');
...
(1, '0', '0', '0'),
(2, 'luhar nauman', 'harshilsoni485@gmail.com', 'asdfhk'),
(3, '', 'harshilsoni90909@gmail.com', '90909'),
(4, '', 'harshilsoni90909@gmail.com', '90909'),
(5, '', 'harshilsoni90909@gmail.com', '90909'),
(6, '', 'harshilsoni485@gmail.com', '12345'),
(7, '', 'harshilsoni485@gmail.com', '12345'),
(8, '', 'harshilsoni485@gmail.com', ''),
(9, '', 'harshilsoni485@gmail.com', ''),
(10, '', 'harshilsoni485@gmail.com', ''),
(11, '', 'harshilsoni485@gmail.com', ''),
(12, '', 'harshilsoni485@gmail.com', '12345'),
(13, '', 'harshilsoni485@gmail.com', '');
...
--
-- Indexes for table `add course`
--
ALTER TABLE `add course`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `all_professor`
--
ALTER TABLE `all_professor`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `attandencegraph`
--
ALTER TABLE `attandencegraph`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `add course`
--
ALTER TABLE `add course`
...
--
-- AUTO_INCREMENT for table `all_professor`
--
ALTER TABLE `all_professor`
  MODIFY `id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `attandencegraph`
--
ALTER TABLE `attandencegraph`
...
--
ALTER TABLE `sas_attendance`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
