...
<a href="map-grid.php" class="grid-view"><i class="fas fa-th-large"></i></a>
<a href="map-list.php" class="list-view active"><i class="fas fa-bars"></i></a>
</div>
...
<h4 class="usr-name"><a href="profile.php">Ruby Perrin</a></h4>
...
<div class="user-info-cont">
<h4 class="usr-name"><a href="profile.php">Darren Elder</a></h4>
...
<div class="user-info-cont">
<h4 class="usr-name"><a href="profile.php">Deborah Angel</a></h4>
...
<div class="user-info-cont">
<h4 class="usr-name"><a href="profile.php">Sofia Brient</a></h4>
...
<div class="user-info-cont">
<h4 class="usr-name"><a href="profile.php">Katharine Berthold</a></h4>
<p class="mentor-type">UNIX, Calculus, Trigonometry</p>
<div class="rating">
<i class="fas fa-star filled"></i>
<i class="fas fa-star filled"></i>
