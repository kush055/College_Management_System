...
<img src="assets/img/user/krs20.png" alt="Avatar" class="avatar">
...
<h4 class="widget-title">EXPERIENCE: 15 YEARS</h4>
</div>
...
<div class="row-result">NETWORKING, MAINTENANCE & SECURITY</div>
</div>
</div>
</li>
<li>
...
<div class="row-result">BE IN COMPUTER </div>
</div>
</div>
</li>
...
<div class="row-result"> L.C.Institute of Technology, Bhandu,
Affiliated to Hemchandracharya North Gujarat University</div>
...
<div class="row-result"><li>Government Polytechnic For Girls, Ahmedabad since Sept 2008.
</li></h4>
